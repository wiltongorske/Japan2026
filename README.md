...
- A responsive itinerary site with destination-based filtering and day-by-day navigation.
- Structured trip data for flights, hotels, meals, museums, shopping, sightseeing, and activities.
- A visual route overview, spotlight section, and richly linked timeline cards.
- A GitHub Pages-friendly static setup with no build step and no framework dependency.
...
- `CSS3`
- `Vanilla JavaScript`
- Free/open image sources and hosted assets
