const itinerary = [
  ...
  },
  {
    ...
    items: [
      { time: "7:53 AM", activity: "SPACIA X 001 departs Tokyo Skytree", notes: "Seat: Car 6, Room 3", kind: "event" },
      ...
      { time: "", activity: "Tickets: tobu-japantrip-tickets.com", notes: "", kind: "event" },
      { time: "Hotel: Hoshinoya Tokyo", activity: "1-9-1 Otemachi, Chiyoda-ku, Tokyo 100-0004", notes: "", kind: "hotel" },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { time: "9:30 AM", activity: "Meet at Himeji Station JR Line (Central North Exit or Himeji Castle Exit near 7-11)", notes: "", kind: "event" },
      ...
      { time: "1:30 PM", activity: "Lunch: Il Riccio (leave at 2:45pm for train)", notes: "", kind: "event" },
  ...
  },
  {
    ...
    items: [
      ...
      { time: "9:35 AM", activity: "Train to Okayama (grab train food)", notes: "", kind: "event" },
      { time: "10:58 AM", activity: "NOZOMI 16 departs Okayama for Tokyo", notes: "Green Car: Car 8, seats 11A / 11B", kind: "event" },
      { time: "2:15 PM", activity: "Arrive Tokyo", notes: "", kind: "event" },
